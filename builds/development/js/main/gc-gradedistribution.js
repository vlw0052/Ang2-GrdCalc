System.register(['angular2/core', './grades.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            GCGradeDistribution = (function () {
                function GCGradeDistribution(gradesService) {
                    this.gradesService = gradesService;
                    this.gradeSections = gradesService.get();
                    console.log(gradesService);
                }
                GCGradeDistribution = __decorate([
                    core_1.Component({
                ...
                return GCGradeDistribution;
            }());
            exports_1("GCGradeDistribution", GCGradeDistribution);
        }
    }
});

//# sourceMappingURL=gc-gradedistribution.js.map
